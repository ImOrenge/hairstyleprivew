...
export type AftercareGuidanceOffset = "D+1" | "D+3" | "D+7" | "D+30" | "D+45" | "D+90";
export interface CareProgram { actualServiceId: string | null; programVersion: number; today: string[]; checkpoints: Array<{ offset: AftercareGuidanceOffset; action: string; complete: boolean }>; concerns: string[]; afterPhotoUrl: string | null; afterPhotoUpload?: { actualServiceId: string; fingerprint: string; uploadedAt: string } | null; satisfaction: number | null }
