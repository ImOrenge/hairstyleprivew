...
> **V2 적용 고지 (2026-08-13):** 이 문서는 에디토리얼 레이아웃·모션·이미지 자산의 구현 이력을 보존한다. 아래의 `/workspace`, 무료 생성기, 기존 가격·크레딧 계약은 더 이상 제품 기준이 아니다. 제품 기준은 `docs/hairfit-v2-premium-landing-baseline-2026-08-12.md`, 실행 권위는 `docs/hairfit-v2-premium-landing-redesign-implementation-2026-08-13.md`이며 B2C 진입점은 `/consulting/new`이다.
