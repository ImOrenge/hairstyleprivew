...
- 실제 사용자 사진·Clerk 로그인·외부 Gemini 9장 생성은 실행하지 않았다. 2026-08-12 사용자 승인으로 실인증·실사진, 유료 hair/Fashion 생성, 실제 시술 기반 Aftercare 실증을 종료조건에서 제외했으며 정적/빌드 결과를 해당 실증 통과로 확대하지 않는다.
