...
| 구분 | 변수 |
| --- | --- |
| PortOne 공개 설정 | `NEXT_PUBLIC_PORTONE_V2_STORE_ID`, `NEXT_PUBLIC_PORTONE_V2_CHANNEL_KEY`, `NEXT_PUBLIC_PORTONE_V2_USAGE_PACK_CHANNEL_KEY` |
| PortOne 서버 설정 | `PORTONE_V2_STORE_ID`, `PORTONE_V2_CHANNEL_KEY`, `PORTONE_V2_USAGE_PACK_CHANNEL_KEY`, `PORTONE_V2_API_SECRET`, `PORTONE_V2_WEBHOOK_SECRET` |
