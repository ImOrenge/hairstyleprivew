...
const sections = [
  {
    ...
    items: [
      ...
      "광고·제휴 문의 데이터: 제휴 유형, 브랜드/회사명, 담당자명, 이메일, 캠페인 목표, 희망 시점, 예산 구간, 상세 내용, 개인정보 동의 시각. 선택 입력 시 회사 웹사이트, 연락처, 타깃 고객, 참고 URL.",
    ],
  },
  {
    ...
    items: [
      ...
      "광고·제휴 문의의 적합성 검토, 협업 범위 협의 및 담당자 회신.",
    ],
  },
  {
    ...
    items: [
      ...
      "미계약 광고·제휴 문의는 접수일로부터 1년 동안 보관한 뒤 자동 파기합니다. 계약 완료 문의는 계약 이행과 분쟁 대응 등 별도 보관 근거에 따라 보관할 수 있으며, 계약 완료 단계에서 벗어나 보유 기간이 만료된 경우 다음 정리 작업에서 파기합니다.",
      ACCOUNT_DELETION_DISCLOSURE,
  ...
  },
  {
    ...
    items: [
      ...
      "광고·제휴 문의자는 개인정보 수집·이용 동의를 거부할 수 있으나, 필수 정보 수집에 동의하지 않으면 제휴 문의를 제출할 수 없습니다.",
    ],
  },
  {
  ...
  return (
    <AppPage className="max-w-4xl pb-16 pt-8">
      <Panel as="header" className="p-5 sm:p-6">
        ...
        <p className="mt-2 text-sm text-[var(--app-muted)]">최종 수정일: 2026-08-26</p>
      </Panel>
