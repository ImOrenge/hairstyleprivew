...
import { ensureMakeupArtistBrief } from "../../../../../../lib/makeup/makeup-artifacts-server";
...
export async function POST(_request: Request, { params }: Params) {
  ...
  try { return NextResponse.json({ brief: await ensureMakeupArtistBrief(userId, sessionId) }); }
