...
import { revalidateFashionOfferSnapshotsV2 } from "../../../../../../../../lib/consulting/fashion-product-offer-server";
...
export async function POST(request: Request, { params }: Params) {
  ...
  try {
    return NextResponse.json({ results: await revalidateFashionOfferSnapshotsV2(userId, consultationId, compatibleSizes) });
  } catch (error) {
