...
import { createSalonBriefV2, getLatestSalonBriefV2 } from "../../../../../../lib/v2/outputs-server";
...
export async function GET(_request: Request, { params }: Params) {
  ...
  try { return NextResponse.json({ brief: await getLatestSalonBriefV2(userId, consultationId) }); }
