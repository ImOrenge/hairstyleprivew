export type WebUserErrorContext = "default" | "photo";
...
export function mapWebUserError(
  error: unknown,
  fallbackMessage: string,
  context: WebUserErrorContext = "default",
) {
...
export function mapWebResponseError(
  status: number,
  fallbackMessage: string,
  context: WebUserErrorContext = "default",
) {
  return mapWebUserError({ status }, fallbackMessage, context);
}
