...
function page(seed: PageSeed): DiscoveryPageDefinition {
  ...
  return {
    ...
    message: {
      ...
      finalSupport: seed.finalSupport,
      forbiddenClaims,
    },
    sample: seed.sample,
...
export const discoveryPages = [
  page({
    ...
    sampleLabel: "내 사진으로 후보 비교 시작",
    finalLabel: "내 사진으로 9가지 후보 만들기",
    ...
    manifestId: "SAMPLE-D-AI-SIM-FEMALE-V2",
  ...
  page({
    ...
    sampleLabel: "얼굴선 후보 보드 만들기",
    finalLabel: "내 얼굴선으로 후보 비교하기",
    ...
    manifestId: "SAMPLE-D-FACE-FEMALE-V2",
  ...
  page({
    ...
    sampleLabel: "내 가르마 후보 만들기",
    finalLabel: "내 사진으로 남자 헤어 비교",
    ...
    manifestId: "SAMPLE-D-MEN-MALE-V2",
  ...
  page({
    ...
    sampleLabel: "내 길이 후보 만들기",
    finalLabel: "내 사진으로 여자 헤어 비교",
    ...
    manifestId: "SAMPLE-D-WOMEN-FEMALE-CLASSIC",
  ...
  page({
    ...
    sampleLabel: "내 앞머리 후보 만들기",
    finalLabel: "자르기 전 앞머리 비교",
    ...
    manifestId: "SAMPLE-D-BANGS-FEMALE-CLASSIC",
  ...
  page({
    ...
    sampleLabel: "내 단발 후보 만들기",
    finalLabel: "자르기 전 단발 비교",
    ...
    manifestId: "SAMPLE-D-BOB-FEMALE-CLASSIC",
  ...
  page({
    ...
    primaryLabel: "미용실 상담 보드 만들기",
    sampleLabel: "내 상담 후보 정리하기",
    finalLabel: "Salon Brief 준비 시작",
    ...
    manifestId: "SAMPLE-D-SALON-FEMALE-V2",
