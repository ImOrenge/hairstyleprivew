...
test("audited static UI copy keeps implementation and generic English labels off user screens", () => {
  ...
  const webPassCopy = [read("../app/home/page.tsx"), read("../components/billing/SubscriptionPolicyDisclosure.tsx"), read("../components/mypage/SubscriptionCancelButton.tsx"), myPagePlanPanel, read("../lib/resend.ts")].join("\n");
