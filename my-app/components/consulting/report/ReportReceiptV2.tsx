...
export function ReportReceiptV2({ report, onRetryNarrative }: { report: ConsultationReportViewModelV2; onRetryNarrative?: () => void }) {
  return <article data-report-receipt="true" data-report-view-model="v2" className="f-consulting-report__receipt f-consulting-report-v2 mx-auto w-full max-w-[72rem] border border-[var(--app-border)] bg-[var(--app-surface)] text-[var(--app-text)]">
    ...
    <Suspense fallback={<ReportTabsFallback report={report} />}><ReportTabsV2 tabs={report.tabs} defaultTab={report.defaultTab} narrative={report.narrative} onRetryNarrative={onRetryNarrative} /></Suspense>
