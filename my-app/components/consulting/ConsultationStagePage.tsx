...
function ConsultationStageContent({ initialSnapshot, initialReport, stage, initialTransitionKind, livenessEnabled, pollingEnabled, interviewEnabled, progressiveInterviewEnabled, zeroInputIntakeEnabled, chapterNavigationEnabled, hairRecommendationEnabled }: { initialSnapshot: ConsultationSnapshot; initialReport?: ConsultationReportViewModelV2 | null; stage: ConsultationStage; initialTransitionKind?: ConsultationTaskKind | null; livenessEnabled: boolean; pollingEnabled: boolean; interviewEnabled: boolean; progressiveInterviewEnabled: boolean; zeroInputIntakeEnabled: boolean; chapterNavigationEnabled: boolean; hairRecommendationEnabled: boolean }) {
  ...
  return <ConsultationScene snapshot={snapshot} stage={stage} surface={surface} notice={notice} onRefresh={() => void refresh()} chapterNavigationEnabled={chapterNavigationEnabled}>{content}</ConsultationScene>;
}

export function ConsultationStagePage({ initialSnapshot, initialReport = null, stage, initialTransitionKind = null, livenessEnabled = true, pollingEnabled = true, interviewEnabled = false, progressiveInterviewEnabled = true, zeroInputIntakeEnabled = true, chapterNavigationEnabled = true, hairRecommendationEnabled = false }: { initialSnapshot: ConsultationSnapshot; initialReport?: ConsultationReportViewModelV2 | null; stage: ConsultationStage; initialTransitionKind?: ConsultationTaskKind | null; livenessEnabled?: boolean; pollingEnabled?: boolean; interviewEnabled?: boolean; progressiveInterviewEnabled?: boolean; zeroInputIntakeEnabled?: boolean; chapterNavigationEnabled?: boolean; hairRecommendationEnabled?: boolean }) {
  return <ConsultationTaskRuntimeProvider><ConsultationStageContent initialSnapshot={initialSnapshot} initialReport={initialReport} stage={stage} initialTransitionKind={initialTransitionKind} livenessEnabled={livenessEnabled} pollingEnabled={pollingEnabled} interviewEnabled={interviewEnabled} progressiveInterviewEnabled={progressiveInterviewEnabled} zeroInputIntakeEnabled={zeroInputIntakeEnabled} chapterNavigationEnabled={chapterNavigationEnabled} hairRecommendationEnabled={hairRecommendationEnabled} /></ConsultationTaskRuntimeProvider>;
}
