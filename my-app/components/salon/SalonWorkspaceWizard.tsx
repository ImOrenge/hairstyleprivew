...
const INSUFFICIENT_CREDITS_MESSAGE = "이용할 수 있는 처리량이 부족합니다. 추가 이용량을 구매한 뒤 다시 시도해 주세요.";
...
function isInsufficientCreditsError(error: unknown) {
  ...
  return (
    ...
    (error.status === 409 && (message.includes("credit") || message.includes("이용량") || message.includes("크레딧")))
  );
}
